...
from monitor.models import project_t, minion_ip_t, minion_t, cdn_proj_t, project_authority_t
from monitor.models import telegram_domain_alert_t, telegram_ssl_alert_t, dns_authority_t, permission_t
